...
@section('content')
    ...
    <div class="card shadow-sm border-0 data-card">
        <div class="card-header bg-white border-0 py-3">
            ...
            <form method="GET" action="{{ route('vendor.return-requests') }}" class="row g-2 align-items-center">
                <div class="col-lg-8">
                ...
                <div class="col-lg-2 d-flex gap-2">
                    ...
                    <a href="{{ route('vendor.return-requests') }}" class="btn btn-outline-secondary btn-sm">
                        ...
                        <thead>
                            <tr>
                                <th class="text-nowrap sortable-col">
                                    ...
                                    @endphp
                                    <a class="text-decoration-none text-reset" href="{{ route('vendor.return-requests', array_merge(request()->except('page'), ['sort_by' => 'return_number', 'sort_dir' => $returnNumberDir])) }}">
                                ...
                                <th class="text-nowrap sortable-col">
                                    ...
                                    @endphp
                                    <a class="text-decoration-none text-reset" href="{{ route('vendor.return-requests', array_merge(request()->except('page'), ['sort_by' => 'customer', 'sort_dir' => $customerDir])) }}">
                                ...
                                <th class="text-nowrap sortable-col">
                                    ...
                                    @endphp
                                    <a class="text-decoration-none text-reset" href="{{ route('vendor.return-requests', array_merge(request()->except('page'), ['sort_by' => 'order_number', 'sort_dir' => $orderNumberDir])) }}">
                                ...
                                <th class="text-nowrap sortable-col">
                                    ...
                                    @endphp
                                    <a class="text-decoration-none text-reset" href="{{ route('vendor.return-requests', array_merge(request()->except('page'), ['sort_by' => 'items', 'sort_dir' => $itemsDir])) }}">
                                ...
                                <th class="text-nowrap sortable-col">
                                    ...
                                    @endphp
                                    <a class="text-decoration-none text-reset" href="{{ route('vendor.return-requests', array_merge(request()->except('page'), ['sort_by' => 'refund_amount', 'sort_dir' => $refundDir])) }}">
                                ...
                                <th class="text-nowrap sortable-col mobile-hide">
                                    ...
                                    @endphp
                                    <a class="text-decoration-none text-reset" href="{{ route('vendor.return-requests', array_merge(request()->except('page'), ['sort_by' => 'pickup_date', 'sort_dir' => $pickupDateDir])) }}">
                                ...
                                <th class="text-nowrap sortable-col mobile-hide">
                                    ...
                                    @endphp
                                    <a class="text-decoration-none text-reset" href="{{ route('vendor.return-requests', array_merge(request()->except('page'), ['sort_by' => 'created_at', 'sort_dir' => $createdAtDir])) }}">
                        ...
                        <tbody>
                            @foreach ($returnRequests as $request)
                                <tr>
                                    ...
                                    <td><span class="count-pill packages-pill">{{ $request->vendor_items_count ?? $request->items->count() }}</span></td>
                                    <td>{{__('admin-dashboard.EGP')}}{{ number_format($request->vendor_refund_amount_sum ?? $request->refund_amount ?? $request->calculateRefundAmount(), 2) }}</td>
                                    ...
                                    <td>
                                        <div class="actions-group">
                                            <a href="{{ route('vendor.return-requests.show', $request->id) }}" class="btn btn-sm btn-primary text-white action-icon-btn"
