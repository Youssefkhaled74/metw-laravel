...
@section('title', __('admin-dashboard.edit_state'))
@section('page-title', __('admin-dashboard.edit_state'))
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ __('admin-dashboard.edit_state') }}</li>
@endsection
        ...
        <div class="col-lg-8">
            <div class="card form-card shadow-sm border-0">
                ...
                <div class="card-body pt-0">
                    <form action="{{ route('admin.settings.states.update', $state->id) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="d-flex flex-wrap gap-2 justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary rounded-pill px-4 btn-save">
                                <i class="fas fa-save me-1"></i> {{ __('admin-dashboard.edit_state') }}
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <div class="card form-side-card border-0 shadow-sm h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted mb-0 small">
                        {{ app()->getLocale() === 'ar'
                            ? 'سيتم حفظ المحافظة داخل مصر تلقائيًا.'
                            : 'The state will always be saved under Egypt automatically.' }}
                    </p>
                </div>
            </div>
        </div>
