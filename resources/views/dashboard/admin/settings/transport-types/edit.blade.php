...
@section('title', app()->getLocale() === 'ar' ? 'تعديل نوع نقل' : 'Edit Transport Type')
@section('page-title', app()->getLocale() === 'ar' ? 'تعديل نوع نقل' : 'Edit Transport Type')
...
@php
    ...
    $oldUnlimited = old('unlimited_capacity', data_get($transportType->metadata, 'unlimited_capacity')) ? true : false;
    $oldActive = old('is_active', $transportType->is_active) ? true : false;
@endphp
...
@section('content')
    <div class="ttf-page" dir="{{ $isArabic ? 'rtl' : 'ltr' }}">
        <section class="ttf-hero-card">
            <div class="ttf-hero-main">
                ...
                <div class="ttf-hero-text">
                    ...
                    <h3>{{ $text('Edit transport type', 'تعديل نوع نقل') }}</h3>

                    <div class="ttf-meta-row">
                        <span>
                            <i class="fas fa-code"></i>
                            {{ $transportType->code }}
                        </span>

                        <span class="{{ $transportType->is_active ? 'is-active' : 'is-inactive' }}">
        ...
        <form action="{{ route('admin.settings.transport-types.update', $transportType) }}" method="POST">
            @csrf
            @method('PATCH')
                    ...
                    <section class="ttf-card">
                        <div class="ttf-section-head">
                            <div>
                                ...
                                <p>{{ $text('Update code and localized names.', 'تحديث الكود والأسماء.') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input
                                    type="text"
                                    name="code"
                                    value="{{ old('code', $transportType->code) }}"
                            ...
                            <div class="col-md-8">
                                ...
                                <input
                                    type="text"
                                    name="name_en"
                                    value="{{ old('name_en', $transportType->name_en) }}"
                            ...
                            <div class="col-md-8">
                                ...
                                <input
                                    type="text"
                                    name="name_ar"
                                    value="{{ old('name_ar', $transportType->name_ar) }}"
                            ...
                            <div class="col-md-12">
                                ...
                                >{{ old('description', $transportType->description) }}</textarea>
                    ...
                    <section class="ttf-card">
                        <div class="ttf-section-head">
                            <div>
                                ...
                                <p>{{ $text('Update weight and volume rules.', 'تحديث قواعد الوزن والحجم.') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 align-items-end">
                            <div class="col-md-4">
                                ...
                                <input
                                    ...
                                    min="0"
                                    name="max_weight"
                                    value="{{ old('max_weight', $transportType->max_weight) }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <input
                                    ...
                                    min="0"
                                    name="max_volume"
                                    value="{{ old('max_volume', $transportType->max_volume) }}"
                    ...
                    <section class="ttf-card">
                        <div class="ttf-section-head">
                            <div>
                                ...
                                <p>{{ $text('Enable or disable this transport type.', 'تفعيل أو تعطيل نوع النقل.') }}</p>
                            </div>
                        </div>
                    ...
                    <section class="ttf-card ttf-sticky">
                        <div class="ttf-section-head">
                            <div>
                                ...
                                <p>{{ $text('Preview current changes before updating.', 'راجع التعديلات قبل الحفظ.') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="ttf-preview">
                            ...
                            <span class="ttf-preview-code" id="previewCode">
                                {{ old('code', $transportType->code) ?: $text('CODE', 'الكود') }}
                            </span>

                            <h4 id="previewName">
                                {{ old('name_en', $transportType->name_en) ?: $text('Transport name', 'اسم نوع النقل') }}
                            </h4>

                            <small id="previewArabicName">
                                {{ old('name_ar', $transportType->name_ar) ?: $text('Arabic name will appear here', 'سيظهر الاسم العربي هنا') }}
                            </small>

                            <p id="previewDescription">
                                {{ old('description', $transportType->description) ?: $text('Description preview will appear here.', 'ستظهر معاينة الوصف هنا.') }}
                            </p>
