...
@section('title', __('admin-dashboard.create_city'))
@section('page-title', __('admin-dashboard.create_city'))
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ __('admin-dashboard.create_city') }}</li>
@endsection
                ...
                <form action="{{ route('admin.settings.cities.store') }}" method="POST">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-success">
                            <i class="fas fa-plus"></i> {{ __('admin-dashboard.create_city') }}
                        </button>
                    </div>
                </form>
            </div>
