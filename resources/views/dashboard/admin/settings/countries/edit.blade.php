...
@section('title', __('admin-dashboard.edit_country'))
@section('page-title', __('admin-dashboard.edit_country'))
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ __('admin-dashboard.edit_country') }}</li>
@endsection
                    ...
                    <form action="{{ route('admin.settings.countries.update', $country->id) }}" method="POST">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> {{ __('admin-dashboard.update_country') }}
                            </button>
                        </div>
                    </form>
                </div>
