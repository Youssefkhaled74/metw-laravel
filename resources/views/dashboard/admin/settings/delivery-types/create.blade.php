...
@section('title', __('admin-dashboard.create_delivery_type'))

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('admin-dashboard.create_delivery_type') }}</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{ route('admin.settings.delivery-types.store') }}" method="POST">
                @csrf
                ...
                <button type="submit" class="btn btn-primary">{{ __('admin-dashboard.create_delivery_type') }}</button>
            </form>
        </div>
    </div>
</div>
