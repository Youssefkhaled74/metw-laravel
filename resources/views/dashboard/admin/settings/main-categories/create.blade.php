...
@section('title', __('admin-dashboard.add_main_category'))
@section('content')
    <div class="container-fluid">
        <h4>{{ __('admin-dashboard.add_main_category') }}</h4>
        <form action="{{ route('admin.settings.main-categories.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('translations.en.slug') is-invalid @enderror"
                    id="slug_en" name="translations[en][slug]" value="{{ old('translations.en.slug') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('translations.ar.slug') is-invalid @enderror"
                    id="slug_ar" name="translations[ar][slug]" value="{{ old('translations.ar.slug') }}">
