...
@section('title', 'إضافة فيديو للموقع')
            ...
            <form action="{{ route('admin.settings.website-videos.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description_ar" rows="3" class="form-control @error('description_ar') is-invalid @enderror">{{ old('description_ar') }}</textarea>
