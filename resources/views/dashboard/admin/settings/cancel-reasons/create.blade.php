...
@section('title', __('admin-dashboard.create_new_cancel_reason'))
@section('page-title', __('admin-dashboard.create_new_cancel_reason'))
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">
        {{ __('admin-dashboard.create_new_cancel_reason') }}
    </li>
@endsection
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.settings.cancel-reasons.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                ...
                                {{ __('admin-dashboard.create_cancel_reason') }}
                            </button>
                        </div>
                    </form>
                </div>
