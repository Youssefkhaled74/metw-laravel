...
<div class="row justify-content-center">
    <div class="col-12 col-xl-10">
        <div class="card shadow-sm border-0 role-form-card">
            ...
            <div class="card-body p-4 p-lg-5">
                <form action="{{ $formAction }}" method="POST" id="roleForm">
                    @csrf
                    @if($formMethod !== 'POST')
                        @method($formMethod)
                    @endif
                    ...
                    <div class="mb-4">
                        <label for="name" class="form-label fw-semibold required">{{ __('admin-dashboard.name') }}</label>
                        <input type="text"
                               class="form-control form-control-lg @error('name') is-invalid @enderror"
                               id="name"
                               name="name"
                               value="{{ old('name', $roleName ?? '') }}"
                               required
                               autofocus>
                        @error('name')
                                            ...
                                            <div class="col-12 col-sm-6 col-lg-4 col-xxl-3">
                                                <label class="permission-tile form-check m-0 w-100 h-100">
                                                    ...
                                                    <span class="permission-tile-inner d-block h-100">
                                                        ...
                                                        <span class="permission-key d-block text-muted small">{{ $permission->name }}</span>
                                                    </span>
                                                </label>
                                            </div>
                                        @endforeach
                    ...
                    <div class="d-flex flex-wrap justify-content-between gap-2 mt-4 pt-2">
