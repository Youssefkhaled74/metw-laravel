@extends('website.layout') {{-- Uses the same main website layout with the header --}}

@section('title', 'تسجيل الدخول - المتاجر | ميتو')

@push('styles')
<style>
    /* Exact CSS to match the Login Screenshot */
    .login-wrapper {
        display: flex;
        ...
        <div class="login-card-wrapper">
            <div class="login-card">
                <div class="login-card-header">
                    ...
                    <h2>تسجيل الدخول</h2>
                    {{-- Dynamically prints "Vendor" or "متاجر" based on the $type passed from the Controller --}}
                    <p>Metw - {{ $type === 'vendor' ? 'المتاجر' : 'Vendor' }}</p>
                </div>
                
                <div class="login-card-body">
                    {{-- Points to the Vendor Login POST route defined in your web.php --}}
