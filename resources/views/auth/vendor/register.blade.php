...
<head>
    ...
    <title>تسجيل مورد جديد - {{ config('app.name') }}</title>
            ...
            <div class="col-lg-8">
                <div class="card auth-card">
                    <div class="auth-header">
                        ...
                        <h4 class="mb-0">تسجيل مورد جديد</h4>
                    </div>
                    <div class="card-body p-4">
                        <form method="POST" action="{{ route('vendor.register') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <label for="country_code" class="form-label">كود الدولة</label>
                        ...
                        <div class="text-center mt-3">
                            <p class="mb-0 text-muted">
                                لديك حساب بالفعل؟
                                <a href="{{ route('vendor.login') }}" class="text-decoration-none text-primary">دخول</a>
                            </p>
                        </div>
                    </div>
                </div>
